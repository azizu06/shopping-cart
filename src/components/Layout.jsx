  ...
  return (
    <div className="app-shell relative min-h-screen overflow-x-clip text-slate-100">
      ...
      >
        ...
        <div className="absolute -right-28 top-48 h-80 w-80 rounded-full bg-violet-500/12 blur-3xl" />
        <div className="absolute -bottom-32 left-1/3 h-96 w-96 rounded-full bg-fuchsia-500/12 blur-3xl" />
      </div>
      <NavBar />
